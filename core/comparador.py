...
class Comparador:
    ...
    def comparar_con_fsd_automatico(self, candidato_hubspot):
        ...
        if not isinstance(candidato_hubspot, dict):
            return {"error": "Candidato HubSpot invalido."}
        ...
        resultado["fsd"] = fsd
        resultado["_hubspot_extra"] = {
            "ticket_id": datos_hs.get("ticket_id", ""),
            "contact_id": datos_hs.get("contact_id", ""),
        }
